...
class Achievement extends Equatable {
  ...
  static List<Achievement> get all => [
    ...
    const Achievement(
      ...
      name: 'Perfect Recall',
      description: '5 perfect Memory levels',
      emoji: '✨',
    ...
    const Achievement(
      ...
      name: 'Memory Pro',
      description: '10 perfect Memory levels',
      emoji: '✨',
      color: Color(0xFF9B59B6),
    ),
    const Achievement(
      ...
      name: 'Memory Genius',
      description: '25 perfect Memory levels',
      emoji: '✨',
      color: Color(0xFF8E44AD),
    ),
    const Achievement(
      ...
      name: 'Eidetic Memory',
      description: '50 perfect Memory levels',
      emoji: '✨',
    ...
    const Achievement(
      ...
      description: '100 perfect Memory levels',
      emoji: '📸',
      color: Color(0xFF6C3483),
    ),
    ...
    const Achievement(
      ...
      name: 'Perfect Day',
      description: '5 perfect daily challenges',
      emoji: '⭐',
      color: Color(0xFFFFD700),
    ),
    const Achievement(
    ...
    const Achievement(
      ...
      name: 'Perfect Streak',
      description: '25 perfect daily challenges',
      emoji: '⭐',
    ...
    const Achievement(
      ...
      description: '50 perfect daily challenges',
      emoji: '⭐',
    ...
    const Achievement(
      ...
      description: '100 perfect daily challenges',
      emoji: '💎',
